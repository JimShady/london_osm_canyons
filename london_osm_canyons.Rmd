...
london_raster[london_raster == 0] <- NA
meanval <- cellStats(london_raster, stat='mean', na.rm=T)

my_breaks <- c(0,5,10,15,20,30,40,50,200)

mycolorkey <- list(at=my_breaks, ## where the colors change
                   labels=list(
                       at=my_breaks ## where to print labels
                     ))

levelplot(london_raster - mean,
