...
roads$cell_count              <- unlist(lapply(extract(london_raster, road_polygons, weights=T, na.rm=F), length))/2 #correct

roads$weighted_mean           <- extract(london_raster, road_polygons, weights=T, fun = mean, na.rm=F)
